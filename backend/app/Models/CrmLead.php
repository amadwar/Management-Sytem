...
final class CrmLead extends Model
{
    ...
    protected function casts(): array { return ['stage' => LeadStage::class, 'estimated_value' => 'decimal:2', 'converted_at' => 'datetime']; }
    public function assignee(): BelongsTo { return $this->belongsTo(User::class, 'assigned_to'); }
    public function convertedCustomer(): BelongsTo { return $this->belongsTo(CrmCustomer::class, 'converted_customer_id'); }
}
