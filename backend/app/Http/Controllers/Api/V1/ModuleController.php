...
final class ModuleController extends Controller
{
    ...
    {
        $rows = Module::query()->where('is_active', true)->orderBy('name')->get()->map(function (Module $module) {
    ...
    public function updateActivation(Request $request, Module $module, TenantContext $context, AuditLogger $audit): JsonResponse
    {
        ...
        abort_if($module->is_core && ! $data['enabled'], 422, 'Core modules cannot be disabled.');
