...
final class OrganizationController extends Controller
{
    ...
    {
        return new OrganizationResource(Organization::query()->firstOrFail());
    }
    ...
    public function update(Request $request, AuditLogger $audit): OrganizationResource
    {
        ...
        $audit->record('organization.updated', $request, Organization::class, $organization->id, ['changes' => array_keys($data)]);
