...
Route::prefix('v1')->group(function (): void {
    ...
    Route::middleware([
        ...
        */
        ...
        Route::get(
            'reference-data',
            [ReferenceDataController::class, 'index']
        );

        Route::get(
            'reference-data/cities',
            [ReferenceDataController::class, 'cities']
        );
        ...
        */
        ...
        Route::prefix('crm')
            ...
            ->group(function (): void {
                ...
                Route::post(
                    'leads/{lead}/convert',
                    [CrmLeadController::class, 'convert']
